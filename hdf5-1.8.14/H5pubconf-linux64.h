/*
  Configuration options for Linux 4 Bit
  Werner Benger, 9. Feb 2015
 */
...
#undef H5_HAVE_FILTER_NBIT

/* Define if support for scaleoffset filter is enabled */
#undef H5_HAVE_FILTER_SCALEOFFSET

/* Define if support for shuffle filter is enabled */
#undef H5_HAVE_FILTER_SHUFFLE
...
/* Define if your system can accurately convert from integers to long double
   values. */
#undef H5_INTEGER_TO_LDOUBLE_ACCURATE

/* Define if your system can convert long double to integers accurately. */
#undef H5_LDOUBLE_TO_INTEGER_ACCURATE
...
/* Define if your system can convert long double to unsigned int values
   correctly. */
#undef H5_LDOUBLE_TO_UINT_ACCURATE
...
#undef H5_PACKAGE_BUGREPORT

/* Define to the full name of this package. */
#undef H5_PACKAGE_NAME

/* Define to the full name and version of this package. */
#undef H5_PACKAGE_STRING

/* Define to the one symbol short name of this package. */
#undef H5_PACKAGE_TARNAME

/* Define to the home page for this package. */
#undef H5_PACKAGE_URL

/* Define to the version of this package. */
#undef H5_PACKAGE_VERSION
...
/*
  Configuration options for MINGW64 4.8.1 64 Bit
  Werner Benger, 9. Feb 2015
 */

#define H5_const const
...
/* Define to the full name and version of this package. */
#define H5_PACKAGE_STRING "HDF5 1.8.14-wbconfig"
